...
class Pad
    constructor: (@easel, @htmlLoc, @height, @width, structure) ->
        ...
        if not structure?
            ...
            new structure.Beam({x:  0, y: gd}, {x: 60, y: 30})
            new structure.Beam({x: 60, y: 30}, {x: 70, y: gd})
            new structure.Beam({x: 70, y: gd}, {x: 20, y: 30})
            new structure.Beam({x: 20, y: 30}, {x:  0, y: gd})
            new structure.Beam({x: 20, y: 30}, {x: 60, y: 30})
            new structure.Beam({x:  0, y: gd}, {x: 10, y: 50})
            new structure.Beam({x: 10, y: 50}, {x:  0, y: 90})
            new structure.Beam({x:  0, y: 90}, {x:  0, y: gd})
            new structure.Beam({x: 10, y: 50}, {x: 20, y: 30})
